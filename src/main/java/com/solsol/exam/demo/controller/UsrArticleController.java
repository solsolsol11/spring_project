...
public class UsrArticleController {
	...
	@ResponseBody
	public ResultData<Article> doAdd(HttpSession httpSesion, String title, String body) {
		boolean isLogined = false;
		int loginedMemberId = 0;
		
		if (httpSesion.getAttribute("loginedMemberId") != null) {
			isLogined = true;
			loginedMemberId = (int)httpSesion.getAttribute("loginedMemberId");
		}
	...
	@ResponseBody
	public ResultData<Integer> doDelete(HttpSession httpSesion,int id) {
