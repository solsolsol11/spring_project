...
CREATE TABLE `member`(
    ...
    delStatus TINYINT (1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '탈퇴여부(0=정상, 1=탈퇴)',
...
CREATE TABLE `board`(
    ...
    delStatus TINYINT (1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '삭제여부(0=정상, 1=탈퇴)',
